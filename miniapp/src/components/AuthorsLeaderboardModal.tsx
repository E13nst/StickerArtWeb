...
const LeaderboardAuthorItem: React.FC<LeaderboardAuthorItemProps> = ({ author, index }) => {
...
export const AuthorsLeaderboardModal: React.FC<AuthorsLeaderboardModalProps> = ({ open, onClose }) => {
  ...
  // Загрузка авторов при открытии модального окна (только один раз)
  useEffect(() => {
    if (!open) return;
