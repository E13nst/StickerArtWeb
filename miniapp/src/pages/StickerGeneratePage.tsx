...
import '../styles/StickerGeneratePage.css';

export const StickerGeneratePage: React.FC = () => {
  ...
  return (
    <Box className="sticker-generate-page">
      <Paper elevation={0} className="sticker-generate-card">
        <Box className="sticker-generate-icon-wrapper">
          <AutoAwesomeIcon className="sticker-generate-icon" />
        </Box>
        
        <Typography variant="h4" className="sticker-generate-title">
          Нарисуйте стикер
        </Typography>
        ...
        >
          <TextField
            ...
            className="sticker-generate-input"
            sx={{
        ...
        <Button
          ...
          className="sticker-generate-button"
          sx={{
            mt: 2,
            py: 1.5,
            borderRadius: '12px',
...
export default StickerGeneratePage;
