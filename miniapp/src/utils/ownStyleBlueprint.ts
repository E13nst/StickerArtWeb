...
export function buildVirtualOwnStylePreset(params: {
  ...
  return {
    ...
    hideFreestylePromptAuthorSupplied: merged.hideFreestylePromptAuthorSupplied,
    removeBackgroundLockedToPreset: merged.removeBackgroundLockedToPreset,
    removeBackgroundEffective: merged.removeBackgroundEffective,
